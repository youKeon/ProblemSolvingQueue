...
public class ProblemTest {
    ...
    public void createProblem() throws Exception {
        //given, when, then
        assertDoesNotThrow(() -> new Problem(member, "test", 1, Category.DFS, false));
    }
    ...
    public void createProblemEmptyUrlException() throws Exception {
        //given, when, then
        assertThatThrownBy(() -> new Problem(member, "", 1, Category.DFS, false))
    ...
    public void createProblemEmptyLevelException() throws Exception {
        //given, when, then
        assertThatThrownBy(() -> new Problem(member, "test", null, Category.TWO_POINTER, false))
                .isInstanceOf(InvalidProblemException.class);
    }
    ...
    public void createProblemLowLevelException() throws Exception {
        //given, when, then
        assertThatThrownBy(() -> new Problem(member, "test", 0, Category.TWO_POINTER, false))
                .isInstanceOf(InvalidProblemException.class);
    }
    ...
    public void createProblemHighLevelException() throws Exception {
        //given, when, then
        assertThatThrownBy(() -> new Problem(member, "test", 6, Category.TWO_POINTER, false))
                .isInstanceOf(InvalidProblemException.class);
    }
}
